...
public class SemanticCheckerTest {
    ...
    public static Collection<Object[]> data() {
        ...
        for (File f : new File("testfile/passed/").listFiles()) {
            if (f.isFile() && f.getName().endsWith(".mx")) {
                params.add(new Object[] { "testfile/passed/" + f.getName(), true });
            }
        }
        for (File f : new File("testfile/compile_error/").listFiles()) {
            if (f.isFile() && f.getName().endsWith(".mx")) {
                params.add(new Object[] { "testfile/compile_error/" + f.getName(), false });
            }
        }
        return params;
    }
